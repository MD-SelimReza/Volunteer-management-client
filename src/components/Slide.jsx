    ...
    >
      ...
      <div className="hero-content w-full flex justify-normal text-neutral-content">
        <div className="lg:px-24 px-12 md:px-16 lg:space-y-8">
          ...
          <p className="relative border-2 items-center justify-center inline-block p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group">
